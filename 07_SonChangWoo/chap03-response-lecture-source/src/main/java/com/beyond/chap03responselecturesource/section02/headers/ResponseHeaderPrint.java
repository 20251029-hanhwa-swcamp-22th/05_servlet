package com.beyond.chap03responselecturesource.section02.headers;
...
public class ResponseHeaderPrint extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    for (String name : responseHeaders) {
      System.out.println(name + " : " + resp.getHeader(name));    // 콘솔
      printWriter.println(name + " : " + resp.getHeader(name));   // 브라우저
