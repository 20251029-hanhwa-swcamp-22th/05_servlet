package com.mycompany.chap02requestlecturesource.section02.formdata;
...
public class FromDataTest extends HttpServlet {

  /* 서블릿에 매핑된 주소로 post방식 요청이 발생하면 호출 되는 메서드 */
  @Override
