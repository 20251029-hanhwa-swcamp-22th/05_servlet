...
public class TestFourServlet extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    MemberDTO requestMember = new MemberDTO("홍길동", 19, "010-2222-3333", "gildong@gmail.com");
    MemberDTO sessionMember = new MemberDTO("이순신", 19, "010-2324-5673", "sunsinlee@gmail.com");
