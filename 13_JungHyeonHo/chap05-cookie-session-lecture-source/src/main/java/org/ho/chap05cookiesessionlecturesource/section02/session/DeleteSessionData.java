package org.ho.chap05cookiesessionlecturesource.section02.session;
...
public class DeleteSessionData extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    // ServletContext a=req.getServletContext(); //Application 단위
    // a.removeAttribute();
    System.out.println("==========기존세션 확인=====================");
     ...
     * */
    System.out.println("=========firstName속성 삭제================");
    ...
    System.out.println("=============세션 만료 후에 다시 불러오기========");
