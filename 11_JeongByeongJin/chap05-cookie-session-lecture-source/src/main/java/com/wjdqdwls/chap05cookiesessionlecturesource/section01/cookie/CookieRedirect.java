package com.wjdqdwls.chap05cookiesessionlecturesource.section01.cookie;
...
public class CookieRedirect extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    /* redirect(재요청) -> req, reso가 새로 만들어짐 */
    System.out.println(request.getParameter("fristName")); // null
