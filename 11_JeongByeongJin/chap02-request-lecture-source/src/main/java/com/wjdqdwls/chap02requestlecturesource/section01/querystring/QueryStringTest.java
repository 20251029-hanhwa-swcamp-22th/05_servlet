package com.wjdqdwls.chap02requestlecturesource.section01.querystring;

import com.wjdqdwls.chap02requestlecturesource.HelloServlet;
...
public class QueryStringTest extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
    ...
    * */
    ...
    int age =
        Integer.parseInt(req.getParameter("age")); // parsing 한다
    java.sql.Date birthday =
        java.sql.Date.valueOf(req.getParameter("birthday"));
    String gender = req.getParameter("gender"); // 라디오 버튼
